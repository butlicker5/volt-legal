...
├─ assets/style.css            → shared clean dark-gold theme (no animation)
├─ assets/app.js               → progress bar, scroll-spy, back-to-top
├─ .nojekyll                   → serve files as-is
└─ README.md                   → this file
```

Clean static design — no background media, no animated scene, nothing to
configure. Just edit the text and host it.
